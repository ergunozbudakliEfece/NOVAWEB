    ...
    public class LoginController : Controller
    {
        ...
        public async Task<ActionResult> MailControl(Login login)
        {
            ...
            if (userinfo != null)
            {
                ...
                Session["AlertLogin"] = "Link mail adresinize gönderilmiştir.";
                ...
                string u = "http://192.168.2.13/sifre/index?l=" + Encrypt(GetLink().ToString()) + "&us=" + Encrypt(GetUserByMail(login.User.USER_MAIL).USER_NAME);
