    ...
    public class SevkiyatController : Controller
    {
        ...
        public ActionResult SiparisRaporu()
        {
            ...
            if (ses.LOG_DATETIME != null)
            {
                ...
                if ((xm != xn) && ses.ACTIVITY_TYPE == "login")
                {
        ...
        public ActionResult SaticiSiparisRaporu()
        {
            ...
            {
                ViewBag.UstKalem = GetSiparisUstKAlemSSIP();
                ViewBag.AltKalem = GetSiparisApiDataSSIP();
                ViewBag.AltKalem1 = ViewBag.AltKalem;
            }
            List<USTKALEMMODEL> list = GetSiparisUstKAlemSSIP();
            List<SiparisModel> list1 = GetSiparisApiDataSSIP();
            decimal? toplamtry = 0;
