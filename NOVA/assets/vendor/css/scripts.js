...
function showFilterOption(tdObject) {
    ...
    filterGrid.append('<div class="ms-3 me-3"><input class="form-check-input info" id="all" type="checkbox" checked>Hepsini Seç</div>');
    function onlyUnique(value, index, self) {
        return self.indexOf(value) === index;
    }
    var $rows = $(tdObject).parents("table").find("tbody tr.filt");
    ...
    $rows.each(function (ind, ele) {
        ...
        div.innerHTML = '<input class="form-check-input info ms-3" type="checkbox" ' + str + ' >' + currentTd.innerHTML;
